    ...
    <div>
      ...
      <section style={{ padding:"var(--s-24) 0 var(--s-20)", position:"relative", overflow:"hidden" }}>
        ...
        <div className="wrap">
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1.1fr 0.9fr", gap:"var(--s-16)", alignItems:"center" }} data-mobile-stack>
            <div className="anim-fade-up stagger">
              ...
              <div style={{ display:"flex", gap:"var(--s-3)", flexWrap:"wrap", marginBottom:"var(--s-10)" }}>
                ...
                <Link to="/jobs" className="btn btn-ghost btn-lg">Browse job board</Link>
              </div>
              ...
              <div className="card" style={{ padding:"var(--s-5)" }}>
                ...
                <div style={{ display:"grid", gap:"var(--s-2)" }}>
                  {DEMO_TASKS.map(({title,pts,cat,done})=>(
                    <div key={title} style={{ display:"flex", alignItems:"center", gap:"var(--s-3)", padding:"var(--s-3) var(--s-4)", borderRadius:"var(--r-lg)", background:"var(--ink-3)" }}>
                      <div style={{ width:18, height:18, borderRadius:5, flexShrink:0, background:done?"var(--sage)":"transparent", border:done?"none":"1.5px solid var(--fog)", display:"grid", placeItems:"center" }}>
                      ...
                      <span style={{ flex:1, fontSize:"var(--t-sm)", fontWeight:500, color:done?"var(--stone)":"var(--cream)", textDecoration:done?"line-through":"none" }}>{title}</span>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 2fr", gap:"var(--s-12)", alignItems:"center" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(5,1fr)", gap:"var(--s-3)" }}>
              {CATEGORIES.map(({e,cat,desc,color,dim})=>(
                <div key={cat} className="card-sm" style={{ textAlign:"center", borderTop:`2px solid ${color}`, paddingTop:"var(--s-5)" }}>
                  <div style={{ width:44, height:44, borderRadius:"var(--r-xl)", background:dim, margin:"0 auto var(--s-3)", display:"grid", placeItems:"center", fontSize:"1.4rem" }}>{e}</div>
      ...
      <section style={{ padding:"var(--s-24) 0", position:"relative", overflow:"hidden" }}>
        <div style={{ position:"absolute", inset:0, background:"radial-gradient(ellipse 50% 70% at 50% 50%, rgba(217,119,6,0.06) 0%, transparent 70%)", pointerEvents:"none" }}/>
        <div className="wrap-narrow" style={{ textAlign:"center", position:"relative" }}>
          ...
          <p className="body-lg" style={{ marginBottom:"var(--s-8)" }}>Free forever. No income tracking. No surveillance. Just you and your growth.</p>
